...
class ProjectEnv(
    ...
    """
    Client for the Project Environment.
    ...
    Example:
        ...
        >>> with ProjectEnv(base_url="http://localhost:8000") as client:
        ...     result = client.reset()
        ...     print(result.observation.echoed_message)
        ...
        ...     result = client.step(ProjectAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = ProjectEnv.from_docker_image("project-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(ProjectAction(message="Test"))
        ... finally:
        ...     client.close()
    """
